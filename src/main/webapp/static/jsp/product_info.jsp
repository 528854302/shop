		...
		<div class="container">
			<div class="row">
				...
				<div style="margin:0 auto;width:950px;">
					<div class="col-md-6">
						<img style="opacity: 1;width:400px;height:350px;" title="" class="medium" src="${pageContext.request.contextPath}/static/${bean.pimage}">
					</div>
				...
				<div style="width:950px;margin:0 auto;">
					...
					<div>
						<img src="${pageContext.request.contextPath}/static/${bean.pimage}">
					</div>
