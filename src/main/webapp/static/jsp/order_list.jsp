...
<html>
	...
	<body>
		...
		<div class="container">
						...
						<c:forEach items="${pb.data }" var="o">
							<tbody>
								<tr class="success">
									...
									<th colspan="1">
										<c:if test="${o.state == 0 }"><a href="${pageContext.request.contextPath }/orderInfo?oid=${o.oid}">去付款</a></c:if>
                                ...
                                <tr class="success">
                                    <th colspan="4">提交订单时间:${o.ordertime } </th>
                                    <th colspan="1">
                                        <a href="${pageContext.request.contextPath }/deleteOrder?oid=${o.oid}&pageNumber=1">删除</a>
                                    </th>
                                </tr>
								<tr class="warning">
									<th>图片</th>
								...
								<c:forEach items="${o.items }" var="oi">
									<tr class="active">
										<td width="60" width="40%">
											...
											<img src="${pageContext.request.contextPath}/static/${oi.product.pimage}" width="70" height="60">
										</td>
										<td width="30%">
			...
			<%@include file="/static/jsp/page.jsp" %>
		</div>
