...
<html>
							...
							<c:forEach items="${cart.items }" var="ci">
								<tr class="active">
									<td width="60" width="40%">
										...
										<img src="${pageContext.request.contextPath}/static/${ci.product.pimage}" width="70" height="60">
									</td>
									<td width="30%">
			...
			<div style="margin-right:130px;">
				...
				<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
					...
					<a href="${pageContext.request.contextPath }/order">
						<input type="button" width="100" value="提交订单" name="submit" border="0" style="background: url('${pageContext.request.contextPath}/static/images/register.gif') no-repeat scroll 0 0 rgba(0, 0, 0, 0);
	...
	<script type="text/javascript">
		function removeFromCart(pid){
			if(confirm("您忍心抛弃我吗?")){
				location.href="${pageContext.request.contextPath}/removeFromCart?&pid="+pid;
			}
		}
	</script>
</html>