...
<div id="wrapper" class="wrapper-fluid banners-effect-3">
    ...
    <header id="header" class=" typeheader-1">
        ...
        <div class="header-top hidden-compact">
            <jsp:include page="/static/jsp/head1.jsp"/>
        </div>
        <!-- //Header Top -->
                                ...
                                <form method="GET" action="index.html">
                                    <div id="search0" class="search input-group form-group">
                                        <div class="select_category filter_type  icon-select hidden-sm hidden-xs">
                                            <select class="no-border" name="category_id" id="c_op">
                                                ...
                                                <div class="container-mega">
                                                    <ul class="megamenu" id="c_ul">
                                                        ...
                                                        <li class="loadmore">
                                                            ...
                                                            <span class="more-view">更多分类</span>
                                                        </li>
    ...
    <footer class="footer-container typefooter-1">
        ...
        <div class="footer-bottom">
            ...
            <div class="copyright-w">
                <div class="container">
                    <div class="copyright">
                        Copyright &copy; 2018.Company name All rights reserved.<a target="_blank" href="http://www.scnoob.com/moban/">&#x7F51;&#x9875;&#x6A21;&#x677F;</a>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    $(function(){
        ...
        $.post("${pageContext.request.contextPath}/category",{},function(obj){
            ...
            //$.each($(obj),function(){});
            $(obj).each(function(){
                //alert(this.cname);  <option value="78"><a href='${pageContext.request.contextPath}/product?cid="+this.cid+"'>"+this.cname+"</a></option>
                $("#c_op").append("<option>"+this.cname+"</option>");
                $("#c_ul").append();
            });
        },"json");
    })
